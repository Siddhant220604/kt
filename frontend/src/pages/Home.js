          ...
          <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6, delay: 0.1 }}
            ...
            <div className="space-y-3">
              <div className="aspect-square rounded-2xl overflow-hidden border border-border bg-card shadow-lg">
                <img src={settings.hero_image_1 || '/images/hero-1.jpg'} alt="Thermocol" className="w-full h-full object-cover" />
              </div>
              <div className="aspect-video rounded-2xl overflow-hidden border border-border bg-card shadow-lg">
                <img src={settings.hero_image_2 || '/images/hero-2.jpg'} alt="Bags" className="w-full h-full object-cover" />
              </div>
            </div>
            <div className="space-y-3 pt-8">
              <div className="aspect-video rounded-2xl overflow-hidden border border-border bg-card shadow-lg">
                <img src={settings.hero_image_3 || '/images/hero-3.jpg'} alt="Cups" className="w-full h-full object-cover" />
              </div>
              <div className="aspect-square rounded-2xl overflow-hidden border border-border bg-card shadow-lg">
                <img src={settings.hero_image_4 || '/images/hero-4.jpg'} alt="Luggage" className="w-full h-full object-cover" />
              </div>
            </div>
          </motion.div>
        </Container>
