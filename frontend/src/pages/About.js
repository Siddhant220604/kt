      ...
      <Section>
        <Container>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-card border border-border rounded-2xl p-5 flex items-start gap-3"><MapPin className="h-5 w-5 text-[hsl(var(--brand-terracotta))]" /><div><div className="font-semibold">Address</div><div className="text-sm text-muted-foreground">{settings.address || '253/121, Below Jaiswal Dharamshala, Nehru Cross, Nadan Mahal Road, Lucknow – 226004, Uttar Pradesh'}</div></div></div>
            ...
            <div className="bg-card border border-border rounded-2xl p-5 flex items-start gap-3"><Clock className="h-5 w-5 text-[hsl(var(--brand-terracotta))]" /><div><div className="font-semibold">Hours</div><div className="text-sm text-muted-foreground">{settings.hours || 'Mon-Wed, Fri-Sun: 10:00 AM - 8:00 PM | Thursday: Closed'}</div></div></div>
          </div>
        </Container>
      </Section>
    </div>
